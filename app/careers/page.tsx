...
const jobOpenings = [
  ...
  },
  {
    ...
    description:
      "We're looking for smart, enthusiastic college students or freshers to join Anvaya Solution as Business Development Interns. You'll help us reach out to potential clients, generate leads, and promote our IT services. This is a performance-driven opportunity with high incentives per successful lead conversion.",
    requirements: [
      "Strong communication skills (English, Hindi, Assamese)",
      "Basic knowledge of websites, apps, or digital marketing (preferred)",
      "Self-motivated with a learning mindset",
      "Smartphone and reliable internet connection",
      "Confidence to approach businesses online or in-person",
    ],
    responsibilities: [
      "Find and connect with potential leads through calls, field visits, or social platforms",
      "Clearly explain Anvaya’s services to small businesses or entrepreneurs",
      "Submit accurate lead information to the sales/CRM system",
      "Follow up with warm leads to help close deals",
      "Collaborate with the core team for guidance and alignment",
    ],
    benefits: [
      "Fixed stipend + High commission per successful lead",
      "Flexible work-from-home setup with part-time hours",
      "Mentorship and training in sales and client outreach",
      "Bonus incentives for top performers",
      "Possibility of full-time position after internship",
    ],
  },
];
